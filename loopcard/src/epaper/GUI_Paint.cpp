...
void Paint_SetMirroring(UBYTE mirror)
{
    if(mirror == MIRROR_NONE || mirror == MIRROR_HORIZONTAL || 
        ...
        Serial.println("mirror should be MIRROR_NONE, MIRROR_HORIZONTAL, \
                    ...
                    UWORD Color, DOT_PIXEL Line_width, LINE_STYLE Line_Style)
{
    if (Xstart > Paint.Width || Ystart > Paint.Height ||
        ...
        Serial.println("Paint_DrawLine Input exceeds the normal display range\r\n");
        return;
    }
                      ...
                      UWORD Color, DOT_PIXEL Line_width, DRAW_FILL Draw_Fill)
{
    if (X_Center > Paint.Width || Y_Center >= Paint.Height) {
        Serial.println("Paint_DrawCircle Input exceeds the normal display range\r\n");
        return;
    }
...
void Paint_DrawString_CN2(UWORD Xstart, UWORD Ystart, const char * pString,
                        UWORD Color_Foreground, UWORD Color_Background)
{
                   ...
                   sFONT* Font, UWORD Color_Foreground, UWORD Color_Background)
{
    ...
    if (Xpoint > Paint.Width || Ypoint > Paint.Height) {
        Serial.println("Paint_DisNum Input exceeds the normal display range\r\n");
        return;
    }
